...
*/
	...
	public String toString() {
		return "FitRecord [headerType=" + headerType + ", localMessageType=" + localMessageType + ", numberOfFields="
				+ numberOfFields + ", numberOfDeveloperFields=" + numberOfDeveloperFields + ", endianness=" + endianness
				+ ", hasDeveloperData=" + hasDeveloperData + ", globalMessageNumber=" + globalMessageNumber
				+ ", fieldDefinitions=" + fieldDefinitions + ", recordData=" + recordData + ", recordLength="
				+ recordLength + ", byteArrayPosition=" + byteArrayPosition + "]";
	}
